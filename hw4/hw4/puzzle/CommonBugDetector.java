...
public class CommonBugDetector {
    public static class CommonBugPuzzleState implements WorldState {
        ...
        public Iterable<WorldState> neighbors() {
            switch (name) {
                case('s'): return createWorldStateList(new ArrayList<Character>(){{add('a');add('x');}});
                case('a'): return createWorldStateList(new ArrayList<Character>(){{add('b');}});
                case('b'): return createWorldStateList(new ArrayList<Character>(){{add('c');}});
                case('c'): return createWorldStateList(new ArrayList<Character>(){{add('d');}});
                case('d'): return createWorldStateList(new ArrayList<Character>(){{add('e');}});
                case('e'): return createWorldStateList(new ArrayList<Character>(){{add('g');}});
                case('x'): return createWorldStateList(new ArrayList<Character>(){{add('c');}});
                default: return null;
            }
        }
...
//         System.out.println(s3.totalNumInMinPQ);
